 ...
 * component. The hook takes a **callback** function and a **delay** in milliseconds as arguments, and **returns** a
 * function that can cancel the interval. The callback function passed to `useInterval` must be stable.
 *
 * ```jsx
 * const cancelInterval = useInterval(callback, delay)
 * ```
 *
 * ```jsdoc
