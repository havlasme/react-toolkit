...
const setUp = initialState => renderHook((state) => useNanoId(state), {initialProps: initialState})
...
describe('useNanoId', () => {
  ...
  it('should return different nanoid when called on different components', () => {
