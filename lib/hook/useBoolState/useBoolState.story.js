 ...
 * function to update it. The update function accepts an optional boolean value (or a function that returns a boolean)
 * to update the state. Calling the update function without an argument (or with non-boolean argument) will toggle the
 * state.
 *
 * ```jsx
