...
/**
 * The `useExternal` is a custom React Hook that provides a declarative way to manage dynamic external loading and unloading within a React component.
 * The hook takes a function as an argument and returns the current loading state of the external, which can be one of the following: 'loading', 'ready', 'error', or `null`.
