...
/**
 * The `useObservable` is a custom React Hook that subscribes to an observable.
 * The hook takes an observable and an optional initial state as arguments and returns a tuple with the current state and a function to update it.
 *
 * ```jsx
