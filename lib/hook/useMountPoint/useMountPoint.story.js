...
/**
 * The `useMountPoint` is a custom React Hook that creates a dom node and appends it to the document body. The hook
 * takes a **callback** as an argument that should create and return a dom node. The hook **returns** the dom node.
 *
 * ```jsx
